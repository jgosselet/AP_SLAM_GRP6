            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Personnel</th>
                        <th>Chambre</th>
                        <th>Auteur de la pré-admission</th>
                        <th>Générer le PDF</th>   
                        <th>Modifier</th>
                        <th>Supprimer</th>                 
                    </tr>
                </thead>
                ...
                LEFT JOIN patient ON hospitalisation.id_patient = patient.id_patient";
                    ...
                    $sql_personnel = "SELECT p.id_personnel, p.nom, m.libelle FROM personnel p
                    ...
                    while($row_global = $result_global->fetch_assoc()) {
                        ...
                        echo "<td>" . htmlspecialchars($row_global['nom_patient'] . " " . $row_global['prenom_patient']) . "</td>";
                        echo "<td>";
                        echo "<select name='id_personnel' required>";
                        foreach ($personnels as $personnel) {
                            $selected = ($personnel['id_personnel'] == $row_global['id_personnel']) ? "selected" : "";
                            echo "<option value='" . $personnel['id_personnel'] . "' $selected>" . htmlspecialchars($personnel['nom'] . ' - ' . $personnel['libelle']) . "</option>";
                        }
                        echo "</select>";
                        echo "</td>";     
                        echo "<td>";
                        ...
                        echo "<td class='action-icons'>
                                <a href='generate_pdf_table.php?id_hospitalisation=" . $row_global['id_hospitalisation'] . "' target='_blank'>
