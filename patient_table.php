        ...
        <table>
            ...
            <tbody>
                ...
                while($row_global = $result_global->fetch_assoc()) {
                    ...
                    echo "<td><input type='text' name='civilite' value='" . $row_global['civilite'] . "' required></td>";
                    ...
                    echo "<td><input type='text' name='cp' value='" . $row_global['cp'] . "' required></td>";
                    ...
                    echo "<td><input type='tel' name='tel' value='" . $row_global['tel'] . "' required></td>";
                    echo "<td><input type='text' name='numero_secu' value='" . $row_global['numero_secu'] . "' required></td>";
                    echo "<td>";
